...
const CinemaAdminCreate = ({ onBack, onSave }) => {
    ...
    <div className="max-w-4xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="flex items-center justify-between mb-12">
        ...
        <h2 className="text-3xl font-black text-white uppercase tracking-tighter drop-shadow-sm">
          <span className="opacity-90">Thêm Cụm Rạp</span> <span className="text-cyan-gradient text-glow-cyan">Mới</span>
        </h2>
      </div>
...
export default CinemaAdminCreate;
