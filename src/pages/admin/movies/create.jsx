...
const MovieAdminCreate = ({ onBack, onSave }) => {
  ...
  const handleSubmit = (e) => {
    ...
    onSave({
      ...formData,
      poster: formData.poster || 'https://images.unsplash.com/photo-1485846234645-a62644f84728?auto=format&fit=crop&q=80&w=500'
    });
  };
    ...
    <div className="max-w-5xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="flex items-center justify-between mb-12">
        ...
        <h2 className="text-3xl font-black text-white uppercase tracking-tighter drop-shadow-sm">
          <span className="opacity-90">Thêm Phim</span> <span className="text-cyan-gradient text-glow-cyan">Mới</span>
        </h2>
      </div>
