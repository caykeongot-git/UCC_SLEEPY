...
const RoomAdminCreate = ({ cinemas, onBack, onSave }) => {
  ...
  return (
    <div className="max-w-7xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="flex items-center justify-between mb-12">
        ...
        <h2 className="text-2xl font-black text-white uppercase tracking-tight">Thêm Phòng <span className="text-cyan-400">Mới</span></h2>
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-4 gap-12">
        ...
        <div className="xl:col-span-3 bg-[#1E293B] border border-slate-700/50 rounded-[3rem] p-12 flex flex-col items-center overflow-x-auto min-h-[700px] relative shadow-2xl backdrop-blur-xl">
          ...
          <div className="w-full max-w-2xl h-1.5 bg-cyan-500 rounded-full mb-32 relative shadow-[0_0_30px_rgba(34,211,238,0.4)]">
             ...
             <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-20 bg-gradient-to-b from-cyan-500/10 to-transparent opacity-50 blur-xl"></div>
          </div>
